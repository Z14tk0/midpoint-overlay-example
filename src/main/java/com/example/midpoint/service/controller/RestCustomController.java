 ...
 */
package com.example.midpoint.service.controller;
...
@Experimental
@RestController
@RequestMapping("/ws/custom")
@SuppressWarnings("unused")
public class RestCustomController extends AbstractRestController {

    private final ModelService modelService;
    private final PrismContext prismContext;

    public RestCustomController(ModelService modelService, PrismContext prismContext) {
