...
public class Scim2WebServiceNotUniqueException extends Scim2WebServiceException {

	private static final long serialVersionUID = -6406285996263572162L;

	public Scim2WebServiceNotUniqueException( String message, String scimDetail) {
		super(Status.CONFLICT, message, scimDetail);
	}

	public Scim2WebServiceNotUniqueException( String message, String scimDetail, Throwable cause) {
		super(Status.CONFLICT, message, scimDetail, cause);
	}
