...
public class ConfigurationTableNavigationPanel<F extends FocusType>
    ...
    private static final transient Trace LOGGER = TraceManager.getTrace(ConfigurationTableNavigationPanel.class);

    public ConfigurationTableNavigationPanel(String id, FocusDetailsModels<F> model, ContainerPanelConfigurationType config) {
        ...
        AjaxLink<PrismObjectWrapper<F>> addButton = new AjaxLink<>(ID_ADD_TRANSFORM, getObjectWrapperModel()) {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                try {
                    ...
                    target.add(ConfigurationTableNavigationPanel.this);
                    return;
                }
                target.add(ConfigurationTableNavigationPanel.this);
            }
